...
void Renderer::initGUI(){
    ...
    // - Font
    ImFont* font = io.Fonts->AddFontFromFileTTF((dirFonts/"Rubik-Regular.ttf").c_str(), 13.f);
    ...
    colors[ImGuiCol_FrameBgHovered]             = ImVec4(0.01f, 0.01f, 0.01f, 1.00f);
    ...
    colors[ImGuiCol_ResizeGripHovered]          = ImVec4(0.06f, 0.06f, 0.06f, 1.00f);
    colors[ImGuiCol_ResizeGripActive]           = ImVec4(0.10f, 0.10f, 0.10f, 1.00f);
    colors[ImGuiCol_InputTextCursor]            = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
    colors[ImGuiCol_TabHovered]                 = ImVec4(0.04f, 0.04f, 0.04f, 1.00f);
    colors[ImGuiCol_Tab]                        = ImVec4(0.02f, 0.02f, 0.02f, 1.00f);
    colors[ImGuiCol_TabSelected]                = ImVec4(0.08f, 0.08f, 0.08f, 1.00f);
    colors[ImGuiCol_TabSelectedOverline]        = ImVec4(0.08f, 0.08f, 0.08f, 1.00f);
    colors[ImGuiCol_TabDimmed]                  = ImVec4(0.02f, 0.02f, 0.02f, 0.78f);
    ...
    colors[ImGuiCol_TableHeaderBg]              = ImVec4(0.04f, 0.04f, 0.04f, 1.00f);
    ...
    colors[ImGuiCol_TableRowBgAlt]              = ImVec4(0.08f, 0.08f, 0.08f, 0.39f);
    colors[ImGuiCol_TextLink]                   = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
    colors[ImGuiCol_TextSelectedBg]             = ImVec4(0.39f, 0.39f, 0.39f, 0.39f);
    colors[ImGuiCol_TreeLines]                  = ImVec4(0.39f, 0.39f, 0.39f, 0.12f);
    colors[ImGuiCol_DragDropTarget]             = ImVec4(0.12f, 0.12f, 0.12f, 0.78f);
    colors[ImGuiCol_NavCursor]                  = ImVec4(0.08f, 0.08f, 0.08f, 0.78f);
    colors[ImGuiCol_NavWindowingHighlight]      = ImVec4(0.59f, 0.55f, 0.55f, 0.59f);
    colors[ImGuiCol_NavWindowingDimBg]          = ImVec4(0.39f, 0.39f, 0.39f, 0.27f);
    colors[ImGuiCol_ModalWindowDimBg]           = ImVec4(0.31f, 0.31f, 0.31f, 0.31f);
}
